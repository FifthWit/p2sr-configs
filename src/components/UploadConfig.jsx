    ...
    return (
        ...
        {uploaded ? (
            <div className="flex flex-col bg-primary dark:bg-dark-primary h-auto w-72 rounded-lg m-4 p-8 text-center items-center justify-center">
                <h1 className='font-bold text-xl'>Submitted!</h1>
            </div>
        ) : (
            <div className="flex flex-col bg-primary dark:bg-dark-primary h-auto w-72 rounded-lg m-4 p-8 text-center items-center justify-center">
                ...
                <form onSubmit={(event) => event.preventDefault()}>
                    ...
                    <button onClick={submitConfig} className="w-full rounded-md bg-blue-500 hover:bg-blue-700 font-bold py-2 px-4 mt-2 transition-all">
                        Upload Config!
                    </button>
                </form>
            </div>
